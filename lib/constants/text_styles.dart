...
class TextStyles {
  // height: if want to have height 32.0px, with font-size 24.0px, we should have height property 1.2
  ...
  static const Badge = TextStyle(
      fontSize: 12, fontWeight: FontWeight.w500, height: 1.5, letterSpacing: -0.25);
}
